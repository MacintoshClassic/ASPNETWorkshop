...
namespace Workshop.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,OrderStatusName,QuantityOrdered")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,OrderStatusName,QuantityOrdered")] OrderStatus orderStatus)
        {
